...
var CELULAR_EMPRESA = '5585998121751';
...
cardapio.eventos = {
  ...
  init: () => {
    ...
    cardapio.metodos.abrirWhatsappFooter();
  }
...
cardapio.metodos = {
  ...
  // diminuir a quantidade do iten no cardápio
  ...
  // aumetar a quantidade do iten no cardápio
  ...
  adicionarAoCarrinho: (id) => {
    ...
    if (qntdAtual > 0) {
      ...
      if (item.length > 0) {
        ...
        // caso ainda não exista o item no carrinho, adicione ele
        else {
...
atualizarCarrinho: (id, qntd) => {
  ...
  //atualiza os valores (R$) toteis do carrinho
  cardapio.metodos.carregarValores();
   ...
   if (cep != "") {
    ...
    //Expressão regular para validar o CEP
     ...
     if (validaCep.test(cep)) {
      ...
      cardapio.metodos.mensagem('Formato CEP inválido.');
      $("#txtCEP").focus();
     }
